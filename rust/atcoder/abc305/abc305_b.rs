...
fn main(){
    ...
    let xs= [0_i64, 3, 4, 8, 9, 14, 23];

    println!("{}", abs(xs[alphabet2idx(AsciiChar::new(p.to_ascii_lowercase()))] as i64 -
    xs[alphabet2idx(AsciiChar::new(q.to_ascii_lowercase()))] as i64));
}
