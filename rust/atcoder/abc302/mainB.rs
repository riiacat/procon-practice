...
fn main(){
    ...
    // println!("{}", a/b + if a%b==0 {0} else {1});

    for hh in 0..h{
        for ww in 0..w{
            if s[hh][ww]!='s'{continue;}

            // 横に s,n,u,k,eがあるか？
            if ww+4 < w{
                if s[hh][ww+1]=='n' && s[hh][ww+2]=='u' && s[hh][ww+3]=='k' && s[hh][ww+4]=='e'{
                    for d in 0..5{
                        println!("{} {}", hh+1, ww+d+1);
                    }
                    return;
            ...
            if hh+4 < h{
                if s[hh+1][ww]=='n' && s[hh+2][ww]=='u' && s[hh+3][ww]=='k' && s[hh+4][ww]=='e'{
                    for d in 0..5{
                        println!("{} {}", hh+d+1, ww+1);
                    }
                    return;
            ...
            // 斜め
            if hh + 4 < h && ww+4<w &&s[hh+1][ww+1]=='n' && s[hh+2][ww+2]=='u' && s[hh+3][ww+3]=='k' && s[hh+4][ww+4]=='e'{
                for d in 0..5{
                    println!("{} {}", hh+d+1, ww+d+1);
                }
                return;
            }

            if hh +4<h && ww>=4 && s[hh+1][ww-1]=='n' && s[hh+2][ww-2]=='u' && s[hh+3][ww-3]=='k' && s[hh+4][ww-4]=='e'{
                for d in 0..5{
                    println!("{} {}", hh+d+1, ww-d+1);
                }
                return;
            ...
            if hh >= 4 && ww+4<w && s[hh-1][ww+1]=='n' && s[hh-2][ww+2]=='u' && s[hh-3][ww+3]=='k' && s[hh-4][ww+4]=='e'{
                for d in 0..5{
                    println!("{} {}", hh-d+1, ww+d+1);
                }
                return;
            ...
            if hh>=4 && ww>=4 && s[hh-1][ww-1]=='n' && s[hh-2][ww-2]=='u' && s[hh-3][ww-3]=='k' && s[hh-4][ww-4]=='e'{
                for d in 0..5{
                    println!("{} {}", hh-d+1, ww-d+1);
                }
                return;
