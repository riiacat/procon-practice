...
fn main(){
    ...
    let mut cnt = vec![0_i64; 200000+1];
    ...
    for a in 1..=200000{
        ...
        for b in 1..=200000{
            ...
            if a % b == 0{
                ...
                if cnt[b] == 0 || cnt[c] == 0 {continue;}
                // let delta =cnta*cnt[b]*cnt[c]*2;
                // eprintln!("{}, {}, {}, d={}", a, b, c, delta);

                res += if a==b || b==c {cnta*cnt[b]*cnt[c]}else{cnta*cnt[b]*cnt[c]*2};
                // res += delta;
            }
        }
    }
