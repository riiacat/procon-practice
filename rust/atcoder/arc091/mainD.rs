...
fn main() {
    ...
    for b in 1..=n{
        ...
        let c = n / b;
        let modu = n % b;
        // eprintln!("b: {}, c: {}, modu: {}, sub: {}", b, c, modu, (b as isize-k as isize));
        ans += max!(0, (b as isize -k as isize) * c as isize);

        // eprintln!("1: {}", ans);
        ans += if modu != 0 {max!(0, modu - k + 1)}else{0};
        // eprintln!("2: {}", ans);
    }
