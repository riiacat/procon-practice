...
fn main(){
    ...
    loop{
        ...
        let new_is_tate = s[0][x] == s[1][x];
        // eprintln!("is_tate, new_is_tate, res, x: {}, {}, {}, {}", is_tate, new_is_tate, res, x);
        // eprintln!("is_tate: {}, x: {}, new: {}, res: {}", is_tate, x, new_is_tate, res);
        match (is_tate, new_is_tate){
            (true, false) => {
                res *= 2; res%=MOD;
            },
            (true, true) => {
